...
sel_df %>% 
  filter(!is.na(gender)) %>% 
ggplot(aes(x= reorder(gender, home_language,function(x)length(x)), fill= quarter)) + geom_bar(position = "dodge") + scale_fill_manual(values=c("#049E64", "#DFB312")) + coord_flip() + labs(x= "", fill = "Semester")
```
...
sel_df %>% 
  filter(!is.na(race)) %>% 
ggplot(aes(x= reorder(race, quarter,FUN = length), fill= quarter)) + geom_bar(position = "dodge") + coord_flip() + labs(x= "", fill = "Semester") + scale_fill_manual(values=c("#049E64", "#DFB312"))
```
...
sel_df %>% 
  filter(!is.na(home_language)) %>% 
ggplot(aes(x= reorder(home_language, quarter,FUN = length), fill= quarter)) + geom_bar(position = "dodge") + coord_flip() + labs(x= "", fill = "Semester") + scale_fill_manual(values=c("#049E64", "#DFB312"))
```

# Social-Emotional Learning (SEL) Survey Responses 

Esta sección contiene tres subsecciones de preguntas centradas en el cuidado, las estrategias SEL y otras preguntas SEL formuladas en la encuesta para estudiantes.
...
a <- wf %>% 
  ...
  labs(x = "", y= "", title = "Estudiantes se preocupan por mí y me tratan con amabilidad", subtitle = "Students care about me and treat me with kindness") + scale_fill_brewer(palette = "Set2") +
...
b <- wf %>% 
  ...
  labs(x = "", y= "", title = "Me preocupo por los demás y los trato con amabilidad", subtitle = "I care about students and treat them with kindness") + scale_fill_brewer(palette = "Set2") +
  geom_text(aes(label= ifelse(Percent > "0.05",scales::percent(Percent), "")), position = position_stack(vjust = .5, reverse = T), size =3, color = "black") + coord_flip() + theme(legend.title = element_blank(), axis.line = element_blank(), axis.ticks = element_blank(),axis.text.x = element_blank(),legend.position = "none")
```
...
sel_long %>% 
  ...
  summarise(y= mean(score, na.rm = T)) %>% 
  ggplot(aes(quarter, y, color = domain, group = domain)) + labs(title= "" ,x = "", y = "Average Rating", color = "",  caption = "Nunca = 0, De Vez En Cuando = 1, Casi Siempre = 2, Siempre = 3", subtitle = "dotted lines indicate overall average of Fall and Winter") + scale_y_continuous(limits = c(0,3))  + geom_point() + geom_line() + facet_wrap(~race) + scale_color_brewer(palette = "Set2") + theme(legend.position = "bottom") + geom_hline(yintercept = 2.54, color = "#66C2A5", linetype = "dashed") + geom_hline(yintercept = 2, color = "#FC8D62", linetype = "dashed") + theme(strip.background = element_blank(), strip.text.x = element_text(face = "bold"))
```
...
sel_long %>% 
  ...
  summarise(y= mean(score, na.rm = T)) %>% 
  ggplot(aes(quarter, y, color = domain, group = domain)) + labs(title= "" ,x = "", y = "Average Rating", color = "",  caption = "Nunca = 0, De Vez En Cuando = 1, Casi Siempre = 2, Siempre = 3", subtitle = "dotted lines indicate overall average of Fall and Winter") + scale_y_continuous(limits = c(0,3))  + geom_point() + geom_line() + facet_wrap(~race + gender) + scale_color_brewer(palette = "Set2") + theme(legend.position = "bottom") + geom_hline(yintercept = 2.54, color = "#66C2A5", linetype = "dashed") + geom_hline(yintercept = 2, color = "#FC8D62", linetype = "dashed") + theme(strip.background = element_blank(), strip.text.x = element_text(face = "bold"))
```
...
a <- wf %>% 
  ...
  labs(x = "", y= "", title = "Tengo estrategias para despegarme", subtitle = "If I get stuck, I choose an effective strategy to succeed") + scale_fill_brewer(palette = "Set2") +
  geom_text(aes(label= ifelse(Percent > "0.05",scales::percent(Percent), "")), position = position_stack(vjust = .5, reverse = T), size =3, color = "black") + coord_flip() + theme(legend.title = element_blank(), axis.line = element_blank(), axis.ticks = element_blank(),axis.text.x = element_blank(),legend.position = "none")
...
b <- wf %>% 
  ...
  labs(x = "", y= "", title = "Tengo estrategias para calmarme cuando estoy molesto", subtitle = "If I get upset, I choose an effective strategy to calm down", caption = "values less than 5% are not shown") + scale_fill_brewer(palette = "Set2") +
  geom_text(aes(label= ifelse(Percent > "0.05",scales::percent(Percent), "")), position = position_stack(vjust = .5, reverse = T), size =3, color = "black") + coord_flip() + theme(legend.title = element_blank(), axis.line = element_blank(), axis.ticks = element_blank(),axis.text.x = element_blank(),legend.position = "none")
```
...
c <- wf %>% 
  ...
  labs(x = "", y= "", title = "Conozco muchas estrategias para solucionar problemas", subtitle = "I know many strategies to solve problems") + scale_fill_brewer(palette = "Set2") +
  geom_text(aes(label= ifelse(Percent > "0.05",scales::percent(Percent), "")), position = position_stack(vjust = .5, reverse = T), size =3, color = "black") + coord_flip() + theme(legend.title = element_blank(), axis.line = element_blank(), axis.ticks = element_blank(),axis.text.x = element_blank(),legend.position = "none")
```
...
d <- wf %>% 
  ...
  labs(x = "", y= "", title = "Comparto con mi familia las estrategias que he aprendido", caption = "values less than 5% are not shown", subtitle = "I share strategies I have learned with my family") + scale_fill_brewer(palette = "Set2") +
  geom_text(aes(label= ifelse(Percent > "0.05",scales::percent(Percent), "")), position = position_stack(vjust = .5, reverse = T), size =3, color = "black") + coord_flip() + theme(legend.title = element_blank(), axis.line = element_blank(), axis.ticks = element_blank(),axis.text.x = element_blank(),legend.position = "none")
```
...
sel_long %>% 
  ...
  group_by(domain, quarter, gender) %>% 
  summarise(y= mean(score, na.rm = T)) %>% 
  ggplot(aes(quarter, y, color = domain, group = domain)) + labs(title= "" ,subtitle = "dotted lines indicate overall average of Fall and Winter", x = "", y = "Average Rating", color = "",  caption = "Nunca = 0, De Vez En Cuando = 1, Casi Siempre = 2, Siempre = 3") + scale_y_continuous(limits = c(0,3), labels = c("Nunca/Never", "De Vez En Cuando/Sometimes", "Casi Siempre/Usually", "Siempre/Always"))  + geom_point() + geom_line() + facet_wrap(~gender) + scale_color_brewer(palette = "Set2") + theme(legend.position = "bottom") + geom_hline(yintercept = 2.06, color = "#66C2A5", linetype = "dashed") + geom_hline(yintercept = 1.73, color = "#FC8D62", linetype = "dashed") + geom_hline(yintercept = 2.05, color = "#8DA0CB", linetype = "dashed") + geom_hline(yintercept = 2.04, color = "#E78AC3", linetype = "dashed") + theme(strip.background = element_blank(), strip.text.x = element_text(face = "bold")) + guides(color = guide_legend(nrow = 2, byrow = TRUE))
```
...
sel_long %>% 
  ...
  group_by(domain, quarter, race) %>% 
  summarise(y= mean(score, na.rm = T)) %>% 
  ggplot(aes(quarter, y, color = domain, group = domain)) + labs(title= "" ,subtitle = "dotted lines indicate overall average of Fall and Winter", x = "", y = "Average Rating", color = "",  caption = "Nunca = 0, De Vez En Cuando = 1, Casi Siempre = 2, Siempre = 3") + scale_y_continuous(limits = c(0,3))  + geom_point() + geom_line() + facet_wrap(~race) + scale_color_brewer(palette = "Set2") + theme(legend.position = "bottom") + geom_hline(yintercept = 2.06, color = "#66C2A5", linetype = "dashed") + geom_hline(yintercept = 1.73, color = "#FC8D62", linetype = "dashed") + geom_hline(yintercept = 2.05, color = "#8DA0CB", linetype = "dashed") + geom_hline(yintercept = 2.04, color = "#E78AC3", linetype = "dashed") + theme(strip.background = element_blank(), strip.text.x = element_text(face = "bold")) + guides(color = guide_legend(nrow = 2, byrow = TRUE))
```
...
sel_long %>% 
  ...
  group_by(domain, quarter, race, gender) %>% 
  summarise(y= mean(score, na.rm = T)) %>% 
  ggplot(aes(quarter, y, color = domain, group = domain)) + labs(title= "", subtitle = "dotted lines indicate overall average of Fall and Winter", x = "", y = "Average Rating", color = "",  caption = "Nunca = 0, De Vez En Cuando = 1, Casi Siempre = 2, Siempre = 3") + scale_y_continuous(limits = c(0,3))  + geom_point() + geom_line() + facet_wrap(~race + gender) + scale_color_brewer(palette = "Set2") + theme(legend.position = "bottom") + geom_hline(yintercept = 2.06, color = "#66C2A5", linetype = "dashed") + geom_hline(yintercept = 1.73, color = "#FC8D62", linetype = "dashed") + geom_hline(yintercept = 2.05, color = "#8DA0CB", linetype = "dashed") + geom_hline(yintercept = 2.04, color = "#E78AC3", linetype = "dashed") + theme(strip.background = element_blank(), strip.text.x = element_text(face = "bold")) + guides(color = guide_legend(nrow = 2, byrow = TRUE))
```
...
a <- wf %>% 
  ...
  labs(x = "", y= "", title = "Tengo la sensación de que encajo aquí", subtitle = "I feel like I belong here") + scale_fill_brewer(palette = "Set2") +
...
b <- wf %>% 
  ...
  labs(x = "", y= "", title = "Hay un adulto en la escuela en el que confío", subtitle = "There is an adult I trust at school") + scale_fill_brewer(palette = "Set2") +
  geom_text(aes(label= scales::percent(Percent)), position = position_stack(vjust = .5, reverse = T), size =3, color = "black") + coord_flip() + theme(legend.title = element_blank(), axis.line = element_blank(), axis.ticks = element_blank(),axis.text.x = element_blank(),legend.position = "none")
```
...
c <- wf %>% 
  ...
  summarise(`voice matters`, "Total" = n, "Percent" = round(n/sum(n),4)) %>% 
  ggplot(aes(x= quarter, y= Percent, fill = `voice matters`)) + geom_col(position = position_stack(reverse = T), width = .5) +
  labs(x = "", y= "", title = "Mi voz importa en nuestra escuela", subtitle = "My voice matters at our school") + scale_fill_brewer(palette = "Set2") +
  geom_text(aes(label= scales::percent(Percent)), position = position_stack(vjust = .5, reverse = T), size =3, color = "black") + coord_flip() + theme(legend.title = element_blank(), axis.line = element_blank(), axis.ticks = element_blank(),axis.text.x = element_blank(),legend.position = "none")
```
...
d <- wf %>% 
  ...
  labs(x = "", y= "", title = "Me emociona aprender", subtitle = "I feel excited about learning") + scale_fill_brewer(palette = "Set2") +
  geom_text(aes(label= scales::percent(Percent)), position = position_stack(vjust = .5, reverse = T), size =3, color = "black") + coord_flip() + theme(legend.title = element_blank(), axis.line = element_blank(), axis.ticks = element_blank(),axis.text.x = element_blank(),legend.position = "none")
```
...
sel_long %>% 
  ...
  group_by(domain, quarter, race, gender) %>% 
  summarise(y= mean(score, na.rm = T)) %>% 
  ggplot(aes(quarter, y, color = domain, group = domain)) + labs(title= "" ,x = "", y = "Average Rating", color= "", subtitle = "dotted lines indicate overall average of Fall and Winter", caption = "Nunca = 0, De Vez En Cuando = 1, Casi Siempre = 2, Siempre = 3") + scale_y_continuous(limits=c(0, 3)) + geom_point() + geom_line() + facet_wrap(~race + gender) + scale_color_brewer(palette = "Set2") + theme(strip.background = element_blank(), strip.text.x = element_text(face = "bold"), legend.position = "bottom") + guides(color = guide_legend(nrow = 2, byrow = TRUE)) + 
  geom_hline(yintercept = 2.21, color = "#66C2A5", linetype = "dashed") + 
  geom_hline(yintercept = 2.10, color = "#FC8D62", linetype = "dashed") + 
  geom_hline(yintercept = 2.33, color = "#8DA0CB", linetype = "dashed") + 
  geom_hline(yintercept = 1.99, color = "#E78AC3", linetype = "dashed") 
...
sel_df %>% 
  ...
  ggplot(aes(quarter, y, fill = race, group = race)) + labs(title= "", x = "", y = "Average Rating", caption = "Nunca = 0, De Vez En Cuando = 1, Casi Siempre = 2, Siempre = 3") + scale_y_continuous(limits = c(0,3), labels = c("Nunca/Never", "De Vez En Cuando/Sometimes", "Casi Siempre/Usually", "Siempre/Always")) + theme(legend.position = "none") + geom_col() + facet_wrap(~race) + geom_text(aes(label= ifelse(y > "1",y, "")), vjust = 1.5, size = 3) + scale_fill_brewer(palette = "Set2") + theme(strip.background = element_blank(), strip.text.x = element_text(face = "bold"))
```
...
```{r}
 wf %>% 
  ...
  labs(x = "", y= "", title = "") + scale_fill_brewer(palette = "Set2") +
...
sel_df %>% 
  ...
  mutate(quarter = factor(quarter, levels = c("W. '21", "F. '20"))) %>%
  ggplot(aes(quarter, y, fill = gender, group = gender)) + labs(title= "", x = "", y = "") + scale_y_continuous(limits = c(0,1)) + theme(legend.position = "none") + geom_col() + facet_wrap(~gender, nrow = 2) + geom_text(aes(label= ifelse(y > "0.05",scales::percent(y), "")), position = position_stack(vjust = .5), size =4, color = "black") + scale_fill_manual(values=c("#049E64", "#DFB312")) + coord_flip() + theme(strip.background = element_blank(), strip.text.x = element_text(face = "bold"), axis.line.y = element_blank(), axis.ticks.y = element_blank(), axis.line.x = element_blank(), axis.ticks.x = element_blank(), axis.text.x = element_blank())
```
...
sel_df %>% 
  ...
  group_by(quarter, race) %>% 
  summarise(y = round(mean(wants_school_adult, na.rm = T),2)) %>% 
  ggplot(aes(quarter, y, fill = race, group = race)) + labs(title= "", x = "", y = "") + scale_y_continuous(limits = c(0,1)) + theme(legend.position = "none") + geom_col() + facet_wrap(~race) + geom_text(aes(label= ifelse(y > "0.05",scales::percent(y), "")), position = position_stack(vjust = .5, reverse = T), size =3, color = "black") + scale_fill_brewer(palette = "Set2") + theme(strip.background = element_blank(), strip.text.x = element_text(face = "bold"), axis.text.y = element_blank(), axis.line.y = element_blank(), axis.ticks.y = element_blank())
```
...
sel_df %>% 
  ...
  group_by(quarter, home_language) %>% 
  summarise(y = round(mean(wants_school_adult, na.rm = T),2)) %>% 
  ggplot(aes(quarter, y, fill = home_language, group = home_language)) + labs(title= "", x = "", y = "") + scale_y_continuous(limits = c(0,1)) + theme(legend.position = "none") + geom_col() + facet_wrap(~home_language) + geom_text(aes(label= ifelse(y > "0.05",scales::percent(y), "")), position = position_stack(vjust = .5, reverse = T), size =3, color = "black") + theme(strip.background = element_blank(), strip.text.x = element_text(face = "bold"), axis.text.y = element_blank(), axis.line.y = element_blank(), axis.ticks.y = element_blank())
```
